...
async function starts() {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const adminbotnumber = ["6283803604589@s.whatsapp.net"]
			const frendsowner = ["6281275812737@s.whatsapp.net"]
			...
			switch(command) {
				...
				case 'menu':
					...
					break
	            case 'mr057':
                    client.sendMessage(id, reffy.reffy(id, A187, tanggal, waktu, whatsapp, youtube, instagram, aktif, nomer, ontime), MessageType.text)
		            break
	            case 'listpubg':
                    client.sendMessage(id, listpubg.listpubg(id, A187, tanggal, waktu, whatsapp, youtube, instagram, aktif, nomer, ontime), MessageType.text)
		            break
	            case 'listml':
                    client.sendMessage(id, listml.listml(id, A187, tanggal, waktu, whatsapp, youtube, instagram, aktif, nomer, ontime), MessageType.text)
		            break
	            case 'listff':
                    client.sendMessage(id, listff.listff(id, A187, tanggal, waktu, whatsapp, youtube, instagram, aktif, nomer, ontime), MessageType.text)
		            break
	            case 'pulsatf':
                    client.sendMessage(id, pulsatf.pulsatf(id, A187, tanggal, waktu, whatsapp, youtube, instagram, aktif, nomer, ontime), MessageType.text)
		            break
	            case 'allpulsa':
                    client.sendMessage(id, allpulsa.allpulsa(id, A187, tanggal, waktu, whatsapp, youtube, instagram, aktif, nomer, ontime), MessageType.text)
		            break
	            case 'paketdata':
                    client.sendMessage(id, paket.paket(id, A187, tanggal, waktu, whatsapp, youtube, instagram, aktif, nomer, ontime), MessageType.text)
		            break
	            case 'listshell':
                    client.sendMessage(id, listshell.listshell(id, A187, tanggal, waktu, whatsapp, youtube, instagram, aktif, nomer, ontime), MessageType.text)
		            break
	            case 'cvpulsa':
                    client.sendMessage(id, cvpulsa.cvpulsa(id, A187, tanggal, waktu, whatsapp, youtube, instagram, aktif, nomer, ontime), MessageType.text)
					break
				case 'info':
					me = client.user
			...
			case 'creator':
               ...
               case 'infogempa':
			    ...
			    case 'otagall':
					...
					mentions('╔══✪〘 Mention All 〙✪══'+teks+'╚═〘 IRFAN BOT 〙', members_id, true)
					break
				case 'clearall':
					if (!isOwner) return reply('Kamu siapa?')
